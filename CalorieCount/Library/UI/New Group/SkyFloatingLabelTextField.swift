...
open class SkyFloatingLabelTextField: UITextField { // swiftlint:disable:this type_body_length
    ...
    @objc open var titleFadeInDuration: TimeInterval = 0.2
    /// The value of the title disappearing duration
    @objc open var titleFadeOutDuration: TimeInterval = 0.3
    ...
    @objc open var titleFont: UIFont = .systemFont(ofSize: 13) {
        didSet {
            updateTitleLabel()
        }
    }
